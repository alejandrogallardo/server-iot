...
server.app.use('/api/sentinelas', body_parser_1.default.json(), sentinela_route_1.default);
server.app.use('/api/usuarios', body_parser_1.default.json(), usuarios_routes_1.default);
server.app.use('/api/login', body_parser_1.default.json(), auth_routes_1.default);
server.start(() => {
